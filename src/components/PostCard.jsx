...
export default function PostCard({ $id, title, blogimg, content }) {
  ...
  return (
    <>
      <div className={`mb-6 mt-6 block rounded-lg  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] lg:mb-0 ${userTheme.themeColor? `bg-[#c9d9ed] text-black`: `bg-[#293758] text-[#e2e8f0]`}`} data-te-ripple-init data-te-ripple-color="light">
        <div className="relative overflow-hidden bg-cover bg-no-repeat ">
          <img src={appwriteService.getFilePreview(blogimg)} className="w-full rounded-t-lg h-72" />
          <a href="#!">
            <div
        ...
        <div className="p-6">
          ...
          <Link to={`/post/${$id}`}>
            <p href="#!" data-te-ripple-init data-te-ripple-color="light"
              className={`inline-block rounded bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal  shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] ${userTheme.themeColor? `bg-[#c9d9ed] text-black`: `bg-[#293758] text-[#e2e8f0]`}`}>Learn
              more</p>
          </Link>
        </div>
      </div>
